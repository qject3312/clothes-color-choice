...
def recommend_outfits(user, clothes, temp=22, situation="데일리", top_n=3):
    ...
    for result in results:
        ...
        outer_id = get_value(result["outfit"].get("outer"), "id", default=id(result["outfit"].get("outer")))
        shoe_id = get_value(result["outfit"].get("shoe"), "id", default=id(result["outfit"].get("shoe")))
