...
class MainUI:
    ...
    def show(self):
        ...
        # 홈 화면도 세로 스크롤/드래그가 가능하게 구성합니다.
        # 창 크기가 작거나 macOS/Windows 렌더링 차이로 카드가 아래에서 잘리는 문제를 방지합니다.
        scroll_outer = tk.Frame(self.app.main_frame, bg=style.BG)
        scroll_outer.pack(fill="both", expand=True)

        canvas = tk.Canvas(scroll_outer, bg=style.BG, highlightthickness=0)
        ...
        menu_card(2, 1, "색상 추천", "옷 하나를 기준으로 나머지 색상을 추천합니다.", "◎", "#0891b2", self.app.show_base_item_recommend_ui)
