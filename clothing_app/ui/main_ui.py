...
class MainUI:
    ...
    def show(self):
        ...
        menu_card(1, 1, "온도 추천", "기온에 맞는 옷 종류를 빠르게 확인합니다.", "℃", style.SUCCESS, self.app.show_temperature_ui)
        menu_card(2, 0, "내 옷장", "저장된 옷 목록과 색상을 확인합니다.", "▦", "#475569", self.app.show_clothes_list)
        menu_card(2, 1, "저장 코디", "저장해 둔 코디 기록을 확인합니다.", "♡", "#334155", self.app.show_outfit_ui)
