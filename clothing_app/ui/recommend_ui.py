...
class RecommendUI:
    ...
    def _render_input_area(self, parent):
        ...
        button_row = tk.Frame(situation_box, bg=style.CARD)
    ...
    def _render_recommendations(self, parent):
        ...
        self.recommendations = recommend_outfits(user, clothes, temp=temp, situation=self.selected_situation.get(), top_n=3)
