...
COLOR_PALETTE = [
    ("검정", "#1a1a1a"), ("흰색", "#ffffff"), ("회색", "#888888"),
    ("네이비", "#1e3a8a"), ("베이지", "#e8d5b7"), ("카키", "#8a8866"),
    ("브라운", "#8b5a3c"), ("빨강", "#dc2626"), ("핑크", "#ec4899"),
    ("노랑", "#fbbf24"), ("파랑", "#3b82f6"), ("초록", "#22c55e"),
]


def build_custom_view(page, go, current_user):
    ...
    def make_result_card():
        ...
        for c_name in info["recommended"]:
            ...
            recommend_widgets.append(
                ft.Container(
                    content=ft.Row(
                        [
                            ft.Container(width=24, height=24, bgcolor=hex_match,
                                         border_radius=RADIUS["sm"],
                                         border=ft.border.all(1, COLORS["border"])),
                            ft.Text(c_name, size=FONT["body_sm"],
        ...
        avoid_widgets = [
            ft.Container(
                content=ft.Text(a, size=FONT["body_sm"],
                                color=COLORS["pink"],
                                weight=ft.FontWeight.W_500),
                padding=ft.padding.symmetric(horizontal=10, vertical=6),
        ...
        return ft.Column(
            [
                card(ft.Column([
                    ...
                    ft.Row(
                        [
                            ft.Container(width=56, height=56,
                                         bgcolor=selected_color["hex"],
                                         border_radius=RADIUS["md"],
                                         border=ft.border.all(1, COLORS["border"])),
                            ft.Column([
                                ft.Text(selected_color["name"],
                                        size=FONT["title_sm"],
                                        weight=ft.FontWeight.BOLD,
                                        color=COLORS["text_primary"]),
                                ft.Text(selected_color["hex"],
                                        size=FONT["body_sm"],
                ...
                card(ft.Column([
                    ...
                    ft.Container(height=4),
                    ft.Text(info["reason"], size=FONT["body_sm"],
                ...
                card(ft.Column([
                    ...
                    ft.Container(height=4),
                    ft.Text(info["avoid_reason"], size=FONT["body_sm"],
                            color=COLORS["text_secondary"]),
                ], spacing=SPACE["sm"])),
            ],
            spacing=SPACE["md"],
        ...
        return ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Text(name, size=FONT["caption"],
                            color=COLORS["text_secondary"],
    ...
    def render_palette():
        return ft.Row([color_swatch(n, h) for n, h in COLOR_PALETTE],
